...
export class kwDisp
{
    ...
    private _bDispData: boolean = false;
    private _bDispDataFltr: boolean = false;
    private _bDispDataIn: boolean = false;
    private _bDispFltr: boolean = false;
    private _bDispId: boolean = false;
    private _bDispInits: boolean = false;
    private _bDispInitsIn: boolean = false;
    private _bDispTag: boolean = false;
    private _bDispView: boolean = false;
    private _bDispViewIn: boolean = false;

    private type: kwtDisp | null = null;
